...
Figure \@ref(fig:plotOccupation) compares job ad counts of Adzuna Australia and IVI job ads counts over time per major occupational group (unsing ANZCO - Australian and New Zealand Standard Classification of Occupations). Again, we scatter plot the data and with a LOESS curve. 
...
Table \@ref(tab:corrOccupation) shows correlation between Adzuna Australia and IVI job ads counts over time per major ANZCO occupational group.
...
Next we plot detailed correlations between the data sources over time for all GCCSAs and occupations (see Figure \@ref(fig:plotCorrelations)).
...
And finally we perform an overall comparsion (data aggregated over time) of Adzuna Australia and IVI job ads counts for all of GCCSAs and occupations (see \@ref(fig:plotGCCSAvsOccupations)).
...
* Moderate to low correlations over time for sales workers, professionals, managers, and clerical and administrative workers. No correlation for machinery operators and drivers, and negative correlations for technicians and trades Workers as well as community and personal service workers.	Especially these negative correlations are surprising and need to be investigated further. 
* When drilling down into occupations by GCCSA over time or aggregated over time it no easy to interpret patterns emerge. For some of these combinations the data correspoens better than for others. However, such detailed data might still be valuable for some and assist in informing if or how much such specific job ads data can be relied on for specific decisions.
...
Although is was a considerable time investment and often challenging with managing project and other work, attending Data School gave me time to practise my (emerging) R skills.